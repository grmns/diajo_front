...
import CuotaCompra from "./components/CuotaCompra";
import CrearProveedor from "./components/CrearProveedor";
import EditarCompra from "./components/EditarCompra";
import CrearCuotaCompra from "./components/CrearCuotaCompra";
      ...
      <Router>
        ...
        <div className="content">
          <Routes>
            ...
            <Route path="/crearCompra" element={isAuthenticated() ? <CrearCompra /> : <Navigate to="/login" />} />
            <Route path="/editarCompra/:id" element={isAuthenticated() ? <EditarCompra /> : <Navigate to="/login" />} />
            <Route path="/cuotaCompra" element={isAuthenticated() ? <CuotaCompra /> : <Navigate to="/login" />} />
            <Route path="/crearProveedor" element={isAuthenticated() ? <CrearProveedor /> : <Navigate to="/login" />} />
            <Route path="/crearCliente" element={isAuthenticated() ? <CrearCliente /> : <Navigate to="/login" />} />
            <Route path="/crearCuotaCompra/:compraId" element={isAuthenticated() ? <CrearCuotaCompra /> : <Navigate to="/login" />} />
          </Routes>
        </div>
      </Router>
